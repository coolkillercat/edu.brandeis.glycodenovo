...
public class CGlycoDeNovo {
	...
	//Xinyi 2020/10/13
	ArrayList<Integer> mPossibleMonosaccharideClassIDs;
	int[] mCompositionConstraint;
	//end 2020/10/13
	...
	//Xinyi 2020/10/13
	public void set_reducing_end_modification(String REM) {
		this.mReducingEndMode = REM;
		this.mReducingEndCompensation = CMass.get_mass_compensation(this.mReducingEndMode, this.mPermethylated);
		if (this.mReducingEndMode.indexOf("REM_M3_Bion_") == 0) {
			this.mFinalPeakCompensation = this.mReducingEndCompensation;
		} else if (this.mReducingEndMode.indexOf("REM_M3_") != 0) {
			this.mFinalPeakCompensation = this.mReducingEndCompensation + ((this.mPermethylated)?CMass.CH2:0) + CMass.H2O;
		}
	}
	//end 2020/10/13
