...
public enum CMonosaccharideSet {
	...
	Xyl( "Xyl", "Xylose", "Xyl", 1, new int[] { 3, 4, 5 }, new int[] { 2, 3, 4, 5, 6 }, 
			...
			new CMonosaccharideInfo(206.1154236883, "C8-H16-O5",
					new String[] { "O", "C2H4O", "C2H4O", "C2H4O", "C2H4O", "CH2" }, new int[] { 0, 0, 1, 1, 1, 0 },
					new double[] { 15.9949146221, 44.0262147505, 44.0262147505, 44.0262147505, 44.0262147505,14.0156500642 }) ), 
	
	dHex( "dHex", "Fucose", "Fuc", 2, new int[] { 3, 4, 5 },	new int[] { 2, 3, 4, 5, 6, 6 },
			new CMonosaccharideInfo(164.0684734957, "C6-H12-O5",
	...
	Glc( "Glc", "Glucose", "Hex", 3, new int[] { 3, 4, 5, 6 }, new int[] { 2, 3, 4, 5, 6, 6 },
	...
	Gal( "Gal", "Galactose",	"Hex", 3, new int[] { 3, 4, 5, 6 }, new int[] { 2, 3, 4, 5, 6, 6 },
			new CMonosaccharideInfo( 180.0633881178, "C6-H12-O6",
					new String[] { "O", "CH2O", "CH2O", "CH2O", "CH2O", "C2H4O" },
					new double[] { 15.9949146221, 30.0105646863, 30.0105646863, 30.0105646863, 30.0105646863, 44.0262147505 }),
			new CMonosaccharideInfo( 250.1416384388, "C10-H20-O6", 
	...
	Man( "Man", "Mannose", "Hex", 3, new int[] { 3, 4, 5, 6 }, new int[] { 2, 3, 4, 5, 6, 6 },
			new CMonosaccharideInfo( 180.0633881178, "C6-H12-O6",
					new String[] { "O", "CH2O", "CH2O", "CH2O", "CH2O", "C2H4O" },
					new double[] { 15.9949146221, 30.0105646863, 30.0105646863, 30.0105646863, 30.0105646863, 44.0262147505 }),
			new CMonosaccharideInfo( 250.1416384388, "C10-H20-O6", 
	...
	GlcA( "GlcA", "Glucuronic acid", "HexA", 4, new int[] { 3, 4, 5 }, new int[] { 2, 3, 4, 5, 6, 6 },
	...
	IdoA( "IdoA", "Iduronic acid", "HexA", 4, new int[] { 3, 4, 5 }, new int[] { 2, 3, 4, 5, 6, 6 },
			new CMonosaccharideInfo( 194.0426526757, "C6-H10-O7", 
					new String[] { "O", "CH2O", "CH2O", "CH2O", "CH2O", "C2H2O2" },
					new double[] { 15.9949146221, 30.0105646863, 30.0105646863, 30.0105646863, 30.0105646863, 58.0054793084 }),
			new CMonosaccharideInfo( 264.1209029967, "C10-H18-O7",
	...
	GalNAc( "GalNAc", "N-acetylgalactosamine",  "HexNAc", 5, new int[] { 4, 5, 6 }, new int[] { 2, 3, 4, 5, 6, 6 },
	...
	GlcNAc( "GlcNAc", "N-acetylglucosamine", "HexNAc", 5, new int[] { 4, 5, 6 }, new int[] { 2, 3, 4, 5, 6, 6 },
			new CMonosaccharideInfo( 221.0899372193, "C8-H15-N-O6",
					new String[] { "O", "CH2O", "C3H5NO", "CH2O", "CH2O", "C2H4O" },
					new double[] { 15.9949146221, 30.0105646863, 71.0371137878, 30.0105646863, 30.0105646863, 44.0262147505 }),
			new CMonosaccharideInfo( 291.1681875403, "C12-H23-N-O6", 
	...
	Kdo( "Kdo", "Kdo", "Kdo", 6, new int[] { 4, 5, 6 }, new int[] { 2, 2, 3, 4, 5, 6, 6, 6 },
	...
	NeuAc( "NeuAc", "N-acetylneuraminic acid", "NeuAc", 7, new int[] { 4, 6 }, new int[] { 2, 2, 3, 4, 5, 6, 6, 6, 6 },
	...
	NeuGc( "NeuGc", "N-glycolylneuraminic acid", "NeuGc", 8, new int[] { 4,	6 }, new int[] { 2, 2, 3, 4, 5, 6, 6, 6, 6 },
	...
	CMonosaccharideSet(String symbol, String name, String sacClass, int classID, int[] legalLinkedInVs,
			int[] carbon2vertex, CMonosaccharideInfo sacNative, CMonosaccharideInfo sacPermethylated) {
		this.symbol = symbol;
		this.name = name;
	...
	// inner static class for abstracting information of both permethylated and
	// non-permed monosacs, must be static otherwise ENUM type values cannot
	// initiate them inside ().
	static class CMonosaccharideInfo {
		...
		private CMonosaccharideInfo(double mass, String compostition, String[] vertexComposition,
				int[] vertexPermethylated, double[] vertexMass) {
			this.mass = mass;
		...
		private CMonosaccharideInfo(double mass, String compostition, String[] vertexComposition, double[] vertexMass) {
			this(mass, compostition, vertexComposition, null, vertexMass); // must use "null" to initiate "vertexPermethylated", otherwise error
		}
	}
}
