...
public class OpenGlycoDeNovo {
	...
	@Execute
	public Object execute(@Named(IServiceConstants.ACTIVE_SELECTION) Object object, IEventBroker eventBroker,
	...
	Shell shell, EPartService partService) {
		...
		if (wizardDialog.getReturnCode() == WizardDialog.OK) {
	        ...
	        eventBroker.send(IGritsDataModelService.EVENT_SELECT_ENTRY, res[1]);
	        try {
